          ...
          itemBuilder: (BuildContext context, int index) {
            return Column(
              children: [
                DesignerList(
                  function: () {},
                  titles: Gordon_Lightfoot,
                  photo: artists1,
                  desc: Sundown,
                  image: dron,
                  url: 'assets/Gordon_Lightfoot_-_Sundown-.mp3',
                  index: 0,
                ),
                ...
                DesignerList(
                  ...
                  desc: Haramy,
                  image: audio,
                  url: 'assets/Najwa Karam - Haramy.mp3',
                  index: 1,
                ),
                SizedBox(height: 15.h),
                DesignerList(
                  function: () {},
                  titles: JeanJacquesGoldmanSirima,
                  photo: artists3,
                  desc: Labas,
                  image: audio1,
                  url: 'assets/Jean-Jacques Goldman, Sirima.mp3',
                  index: 2,
                ),
              ],
            );
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          image: DecorationImage(
              image: AssetImage(widget.image.toString()), fit: BoxFit.fill),
        ),
