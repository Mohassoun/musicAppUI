                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    gradient: LinearGradient(
                      colors: [
                        kBlueColor,
                        anotherColor
                      ], // Merge the two colors using a gradient
                  ...
                  child: Column(
                    ...
                    children: [
                      Padding(
                        padding:
                            EdgeInsets.only(top: 40.h, right: 30.w, left: 30.w),
                        child: CircleAvatar(
                          maxRadius: 30.h,
                          backgroundColor: anotherColor, // Use the second color
                      ...
                      Padding(
                        ...
                        child: Text(
                          'Good Morning! ', // Replace with the text you want
                          style: TextStyle(
                            fontFamily: "Quicksand",
                            fontSize: 55.sp,
                            color: kWhiteColor,
                        ...
                        child: SizedBox(
                          ...
                          child: ElevatedButton(
                            ...
                            style: ElevatedButton.styleFrom(
                              primary: Colors
                                  .transparent, // Use the second color for the button background
                              shape: RoundedRectangleBorder(
                                borderRadius: BorderRadius.circular(10.r),
                                side: BorderSide(
                                    color: Colors.black,
                                    width: 0.05), // Add a simple border
                              ),
                              // Increased elevation for a more solid shadow
                            ),
                            child: Text(
                              'Discover', // Replace with the text you want
                              style: TextStyle(
              ...
              return Align(
                ...
                child: Container(
                  ...
                  margin: EdgeInsets.symmetric(
                      horizontal: isButtonShow.value ? 60 : 90),
                  height: 60.h,
                  // width: 200.w,
                  decoration: BoxDecoration(
                                    ...
                                    showModalBottomSheet<void>(
                                      ...
                                      builder: (
                                        ...
                                        return LiveButtonBottomSheet(
                                          ...
                                          image:
                                              abc.audio.audio.metas.image!.path,
                                        );
                                      },
                                    );
                                  },
