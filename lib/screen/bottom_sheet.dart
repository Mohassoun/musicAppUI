...
class LiveButtonBottomSheet extends StatefulWidget {
  ...
  const LiveButtonBottomSheet(
      {Key? key, this.url, this.image, this.desc, this.title})
      : super(key: key);
...
class _LiveButtonBottomSheetState extends State<LiveButtonBottomSheet>
  ...
  void initState() {
    ...
    _subscriptions
        .add(assetsAudioPlayer.playlistAudioFinished.listen((data) {}));
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: LinearGradient(
          colors: [kBlueColor, anotherColor], // Define the gradient colors here
